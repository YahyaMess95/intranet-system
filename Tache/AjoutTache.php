                        ...
                        <div class="h-100 d-md-flex d-sm-block bg-white justify-content-center align-items-center col-md-12 col-lg-7">
                            <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                                <div>
                                    ...
                                    <form action = "FctTacheAjout.php" method="POST" style="margin-left: 25%; width: 100%;" >
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="position-relative form-group">
                                                    <label for="commentaire" class="">
                                                        <span class="text-danger">*</span> Description du tache :
                                                    </label>
                                                   ...
                                                   <div class="position-relative form-group">
                                                    <label for="commentaire" class="">
                                                        <span class="text-danger">*</span> Date limite  :
                                                    </label>
                                                    <input  name="date1" id="commentaire" type="date" placeholder="Commentaire.." class="form-control" required="required"> 
                                                </div>
                                            </div>
                                            <br><br><br><br>
