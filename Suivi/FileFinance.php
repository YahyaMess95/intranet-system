...
$crud->ajoutSuivie($conn,'vide',$_POST['commentaire'],$_SESSION["EmailSession"],'vide' ,  $_POST['pays'], $_POST['succursale'], $today) ; 
...
header('Location:ListFichierFinance.php');
    ...
    $allowed_file_types = array('.csv','.xls','.xlsx','.docx','.doc','.pdf');  
...
$crud->ajoutSuivie($conn,$filename,$_POST['commentaire'],$_SESSION["EmailSession"],$newfilename , $_POST['pays'], $_POST['siege'], $today) ; 
