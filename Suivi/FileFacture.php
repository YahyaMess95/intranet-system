...
if (isset($_POST['submit'])  )
{
    ...
    if ($_FILES["file"]["name"]=='') {
        ...
        $crud -> ajoutSuivofact($conn , $_SESSION["EmailSession"], '',$today , $_POST['idAdmin']) ; 
    ...
    {   
        ...
        $crud -> ajoutSuivofact($conn ,$filename , $newfilename, $_SESSION["EmailSession"], $today , $_POST['idAdmin']) ; 
