                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        foreach ($crud->affichetache($conn) as $l) {
                                            if ($l["admin"] == $_SESSION["EmailSession"]){
                                    ?>
	                                <tr style="word-break: break-all;">
                                        ...
                                        <td><button class='btn btn-danger' > <a href="SupprimerTache.php?id=<?php echo $l["id"] ;   ?>" style="color:white;" >Supprimer</a></button> </td>

                                        <td><button class='btn btn-success' > <a href="Termine.php?id=<?php echo $l["id"] ;   ?>" style="color:white;" >Terminé</a></button> </td>
