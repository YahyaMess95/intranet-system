                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        foreach ($crud->afficherTransfer($conn) as $l) {
                                            //echo "id = ".$l["id"];
                                            if ($_SESSION["EmailSession"] == $l["destinataire"] ) {
                                               
                                            
                                    ?>
	                                <tr>
                                        <td><?php echo $l["sender"]; ?></td>
                                        <td><?php echo $l["objet"]; ?></td>
                                        <td><?php echo $l["commentaire"]; ?></td>
                                        <td><?php echo $l["date1"]; ?></td>
 <td><center> <a href="../menu/UploadTransfere/<?php echo $l['fichier']; ?>" class="mb-2 mr-2 btn-wide btn-transition btn btn-shadow btn-light">  Telecharger  </a></center></td>                                        
                                    <?php } }?>
	                                </tr>
                                </tbody>
                            </table>
